...
export default async function SupplierEditProductPage({
  ...
  const [productRes, categoriesRes] = await Promise.all([
    supabase
      .from("products")
      .select("id, name, description, category, base_price, moq, sample_price, specifications, image_url, gallery_images, is_flash_deal, flash_discount_pct, flash_starts_at, flash_ends_at, supplier_id")
      .eq("id", id)
      .maybeSingle(),
